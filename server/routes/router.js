...
// route.get("/table/:customListName",services.homeRoutes);
...
//Handling user login
route.post("/login", passport.authenticate("User-auth", {
...
//Handling user login
route.post("/adminlog", passport.authenticate("Admin-auth", {
